...
- Черновик схемы в бд - [image](resources/schema.png)

- Пример настроек для отправки багажных сообщений - [image](resources/headless_baggage.png)

- Пример настроек для отправки из внутренней сети на внешнюю - [image](resources/intext.png)